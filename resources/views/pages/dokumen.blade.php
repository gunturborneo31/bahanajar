...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6"
    x-data="{
        ...
        kategoriList: (() => {
            const kategoriMap = {};
            window.articles.filter(a => a.inaproc_jenis === 'Dokumen' && a.inaproc_kategori).forEach(a => {
            ...
            <nav class="flex text-sm text-[#6B7280] mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        ...
                        <a href="/peraturan" class="text-[#DC2626] hover:underline">Dokumen</a>
                    </li>
