@extends('layouts.app')
@section('title', 'Materi - BahanAjar Pengadaan Barang')
    ...
    <div class="bg-white dark:bg-[#1F2937] rounded-2xl shadow-sm border border-[#E5E7EB] dark:border-[#374151] p-4 mb-6">
        <div class="flex flex-col sm:flex-row gap-3">
            ...
            <div class="relative flex-1">
                ...
                <input x-model="search" type="text" placeholder="Cari materi pengadaan..."
    ...
    <div class="flex gap-6">
        ...
        <main class="flex-1 min-w-0">
            ...
            <div class="flex items-center justify-between mb-4">
                <p class="text-sm text-[#6B7280]"><span class="font-semibold text-[#111827] dark:text-white">9</span> materi ditemukan</p>
